...
class ControllerCommonHeader extends Controller {
	public function index() {
		...
		$data['children_static_pages'] = array();
		$this->load->model('catalog/information');

		$static_pages = $this->model_catalog_information->getInformations();

		foreach ($static_pages as $info_page) {
			if ($info_page['information_id'] == 7 || $info_page['information_id'] == 8) {
				$data['children_static_pages'][$info_page['title']] = $this->url->link('information/information', '&information_id='. $info_page['information_id']);
			} else {
				$data['static_pages'][$info_page['title']] = $this->url->link('information/information', '&information_id='. $info_page['information_id']);
			}

		}
		// dd($data['static_pages']);
