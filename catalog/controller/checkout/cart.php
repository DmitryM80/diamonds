...
class ControllerCheckoutCart extends Controller {
	public function index() {
		...
		if ($this->cart->hasProducts() || !empty($this->session->data['vouchers']) || $this->model_catalog_product->countLots()) {
			...
			// $data['incart_products_qty'] = $this->cart->countProducts();
			$data['incart_products_qty'] = $this->cart->countProducts() + $this->model_catalog_product->countLots();
			...
			foreach ($products as $product) {
				...
				$data['products'][] = array(
					...
					'brilliant_attributes' => $this->model_catalog_product->getProductAttributes($product['product_id'])
				);
			}
			...
			$data['cart_total_cost'] = $this->cart->getTotal();
	...
	public function order()
	{
		...
		if (isset($_POST['user-mail']) && $_POST['user-mail']) {
			$user_email = $_POST['user-mail'];
		}
		if (isset($_POST['user-tel']) && $_POST['user-tel']) {
			$user_tel = $_POST['user-tel'];
		}
		if (isset($_POST['user-comment']) && $_POST['user-comment']) {
